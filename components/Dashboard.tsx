...
const Dashboard: React.FC<DashboardProps> = ({ projects = [], navigateToProject }) => {
              ...
              {stats.detailedProjects.map((project) => (
                <tr key={project.id} className="hover:bg-white transition-colors group cursor-default">
                  ...
                  <td className="px-6 py-5 text-center align-middle">
                    <div className={`w-7 h-7 rounded-full flex items-center justify-center mx-auto shadow-sm border ${
                      project.stats.isPositive 
